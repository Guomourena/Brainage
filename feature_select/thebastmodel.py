...
#%%
adni_dataset = pd.read_csv('/../../../brainage/Data/feature/10_29_newpreprocess_adni_nc_pyradiomics.csv')
...
for i in range(40,50):
    random.shuffle(y)
    model = ['Xgboost']
    automl_explain = AutoML(mode = 'Optuna',algorithms=model,results_path=f'../../../brainage/Data/10times_model/Shuffle_y/{i}',random_state=i)
